...
class TestIntersections:
    def test_create_intersection(self) -> None:
        s = Sphere()
        i = Intersection(3.5, s)
        assert i.t == 3.5
        assert i.obj == s

    def test_create_intersections(self) -> None:
        s = Sphere()
        i1 = Intersection(1, s)
        i2 = Intersection(2, s)
...
class TestIntersect:
    ...
    def test_ray_sphere_tangent(self) -> None:
    ...
    def test_ray_in_front_of_sphere(self) -> None:
        r = Ray(point(0, 0, 5), vector(0, 0, 1))
        s = Sphere()
        xs = r.intersect(s)
        assert xs.count == 2
    ...
    def test_object_is_set(self) -> None:
        r = Ray(point(0, 0, -5), vector(0, 0, 1))
        s = Sphere()
        xs = r.intersect(s)
        assert xs.count == 2
...
class TestHit:
    def test_all_positive_t(self) -> None:
        s = Sphere()
        i1 = Intersection(1, s)
        i2 = Intersection(2, s)
        xs = Intersections(i1, i2)
    ...
    def test_some_negative_t(self) -> None:
        s = Sphere()
        i1 = Intersection(-1, s)
        i2 = Intersection(1, s)
        xs = Intersections(i1, i2)
    ...
    def test_all_negative_t(self) -> None:
        s = Sphere()
        i1 = Intersection(-2, s)
        i2 = Intersection(-1, s)
        xs = Intersections(i1, i2)
