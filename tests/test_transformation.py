...
class TestTransformations:
    ...
    def test_inverse_translate_point(self) -> None:
    ...
    def test_scale_point(self) -> None:
        t = scaling(2, 3, 4)
        p = point(-4, 6, 8)
    ...
    def test_inverse_scale_vector(self) -> None:
    ...
    def test_rotation_x_inverse(self) -> None:
        p = point(0, 1, 0)
