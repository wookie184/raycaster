...
class TestTuple:
    ...
    def test_sub_point_point(self) -> None:
        a = point(3, 2, 1)
        b = point(5, 6, 7)
        c = vector(-2, -4, -6)
        assert a - b == c

    def test_sub_point_vec(self) -> None:
        a = point(3, 2, 1)
        b = vector(5, 6, 7)
        c = point(-2, -4, -6)
        assert a - b == c

    def test_sub_vec_vec(self) -> None:
        a = vector(3, 2, 1)
        b = vector(5, 6, 7)
    ...
    def test_magnitude_float(self) -> None:
        a = vector(1, 2, 3)
