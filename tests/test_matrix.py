...
class TestMatrix:
    ...
    def test_multiply_self(self):
        ...
        assert a * b == Matrix( [20, 22, 50, 48, 44, 54, 114, 108, 40, 58, 110, 102, 16, 26, 46, 42])
    ...
    def test_submatrix(self):
        ...
        c = Matrix([-6, 1, 6, -8, 8, 6, -7, -1, 1])
        assert b.submatrix(2, 1) == c
    ...
    def test_more_inverse(self):
        ...
        exp = Matrix([-0.15385, -0.15385, -0.28205, -0.53846, -0.07692, 0.12308, 0.02564, 0.03077, 0.35897, 0.35897, 0.4359, 0.92308, -0.69231, -0.69231, -0.76923, -1.92308])
        assert a.inverse().is_close(exp)

        b = Matrix([9, 3, 0, 9, -5, -2, -6, -3, -4, 9, 6, 4, -7, 6, 6, 2])
        exp = Matrix([-0.04074, -0.07778, 0.14444, -0.22222, -0.07778, 0.03333, 0.36667, -0.33333, -0.02901, -0.1463, -0.10926, 0.12963, 0.17778, 0.06667, -0.26667, 0.33333])
